...
// 				breps(50) seed(111) ///
// 				save_results("$results\Baseline\111Baseline_dcdh_300_mdm_Never-treated_Collective_Absolute forest loss_sb.dta")
...
// 		ereturn list
	...
	* Cohort identifiers: missing = never-treated.
		...
		* Without controls
		did_imputation forestloss pointid year sociobosque_year [aweight = _weight], autosample fe(pointid year) cluster(cantonid) pretrends(10) horizons(0/10)
...
// 		test (P_10=0) (P_9=0) (P_8=0) (P_7=0) (P_6=0) (P_5=0) (P_4=0) (P_3=0) (P_2=0)
	...
	**## TWFE: reghdfe
	...
	replace post_10 = (distyear >= 10 & _treated==1)
		...
		* Without controls
		reghdfe forestloss pre_* post_* [fweight = _weight], nocons absorb(pointid year) vce(cluster cantonid)
...
// 		matrix reghdfe_col_1_n_v = e(V)
	...
	together perturb(-0.2(0.1)0.2)  noautolegend ///
		graph_opt(title("(a) SB only", size(medlarge)) ///
	...
	graph save "$dir\Results\Event Study\eventstudy_300_mdm_Never-treated_Absolute forest loss_Collective_sb.gph", replace
...
// 		matrix reghdfe_col_1_i_v = e(V)
	...
	together perturb(-0.325(0.13)0.455)  noautolegend ///
		graph_opt(title("(c) SB + IT", size(medlarge)) ///
			xtitle("Periods since the event") ytitle("Estimate of ATT and 95% Conf. Int.") ///
			xlabel(-10(1)10) ylabel(-0.06(0.01)0.03) ///
			legend(order(1 "TWFE"		3 "Borusyak et al. (2024)"	 5 "Callaway & Sant'Anna (2021)" ///
			  7 "Sun-Abraham (2021)"	9 "Cengiz et al. (2019)"	11 "de Chaisemartin & d'Haultfoeuille (2023)") ///
		...
		lag_opt5(msymbol(+) color(green)) lag_ci_opt5(color(green)) ///
 		lag_opt6(msymbol(X) color(pink)) lag_ci_opt6(color(pink))
	graph save "$dir\Results\Event Study\eventstudy_300_mdm_Never-treated_Absolute forest loss_Collective_sb+it.gph", replace
...
// 		matrix dcdh_col_1_p_b = e(didmgt_estimates)
// 		matrix dcdh_col_1_p_v = e(didmgt_variances)
// 		ereturn list
...
// 		matrix reghdfe_col_1_p_v = e(V)
	...
	plottype(scatter) ciplottype(rcap) trimlead(10) trimlag(10) ///
	together perturb(-0.325(0.13)0.455)  noautolegend ///
		graph_opt(title("(b) SB + PA", size(medlarge)) ///
			xtitle("Periods since the event") ytitle("Estimate of ATT and 95% Conf. Int.") ///
			xlabel(-10(1)10) ylabel(-0.06(0.01)0.03) ///
			legend(order(1 "TWFE"		3 "Borusyak et al. (2024)"	 5 "Callaway & Sant'Anna (2021)" ///
				7 "Sun-Abraham (2021)"	9 "Cengiz et al. (2019)"	11 "de Chaisemartin & d'Haultfoeuille (2023)") ///
		...
		lag_opt5(msymbol(+) color(green)) lag_ci_opt5(color(green)) ///
 		lag_opt6(msymbol(X) color(pink)) lag_ci_opt6(color(pink))
	graph save "$dir\Results\Event Study\eventstudy_300_mdm_Never-treated_Absolute forest loss_Collective_sb+pa.gph", replace
...
// 		matrix dcdh_col_1_pi_b = e(didmgt_estimates)
// 		matrix dcdh_col_1_pi_v = e(didmgt_variances)
// 		ereturn list
...
// 		matrix reghdfe_col_1_pi_v = e(V)
	...
	plottype(scatter) ciplottype(rcap) trimlead(10) trimlag(10) ///
	together perturb(-0.325(0.13)0.455)  noautolegend ///
		graph_opt(title("(d) SB + PA + IT", size(medlarge)) ///
			xtitle("Periods since the event") ytitle("Estimate of ATT and 95% Conf. Int.") ///
			xlabel(-10(1)10) ylabel(-0.06(0.01)0.03) ///
			legend(order(1 "TWFE"		3 "Borusyak et al. (2024)"	 5 "Callaway & Sant'Anna (2021)" ///
				7 "Sun-Abraham (2021)"	9 "Cengiz et al. (2019)"	11 "de Chaisemartin & d'Haultfoeuille (2023)") ///
		...
		lag_opt5(msymbol(+) color(green)) lag_ci_opt5(color(green)) ///
 		lag_opt6(msymbol(X) color(pink)) lag_ci_opt6(color(pink))
	graph save "$dir\Results\Event Study\eventstudy_300_mdm_Never-treated_Absolute forest loss_Collective_sb+it+pa.gph", replace
...
// 		matrix reghdfe_ind_1_n_v = e(V)
	...
	together perturb(-0.325(0.13)0.455)  noautolegend ///
		...
		lag_opt5(msymbol(+) color(green)) lag_ci_opt5(color(green)) ///
 		lag_opt6(msymbol(X) color(pink)) lag_ci_opt6(color(pink))
	graph save "$dir\Results\Event Study\eventstudy_300_mdm_Never-treated_Absolute forest loss_Individual_none.gph", replace
...
// 		matrix reghdfe_ind_1_i_v = e(V)
	...
	together perturb(-0.325(0.13)0.455)  noautolegend ///
		...
		lag_opt5(msymbol(+) color(green)) lag_ci_opt5(color(green)) ///
 		lag_opt6(msymbol(X) color(pink)) lag_ci_opt6(color(pink))
	graph save "$dir\Results\Event Study\eventstudy_300_mdm_Never-treated_Absolute forest loss_Individual_sb+it.gph", replace
...
// 				trends_lin(canton_id) ///
// 				breps(50) seed(111) ///
// 				save_results("$results\Baseline_dcdh_300_mdm_Never-treated_Individual_Absolute forest loss_sb+pa.dta")
// 		matrix dcdh_ind_1_p_b = e(didmgt_estimates)
// 		matrix dcdh_ind_1_p_v = e(didmgt_variances)
// 		ereturn list
	**## did_imputation (Borusyak et al., 2024)
	* Regardless of whether the pre-trend test is performed, the reference group for estimation is always all pre-treatment (or never-treated) observations.
	* Only aw or iw are allowed; all weight types (aw/iw/fw/expand _weight) produce identical results.
...
// 		matrix reghdfe_ind_1_p_v = e(V)
	...
	together perturb(-0.325(0.13)0.455)  noautolegend ///
		...
		lag_opt5(msymbol(+) color(green)) lag_ci_opt5(color(green)) ///
 		lag_opt6(msymbol(X) color(pink)) lag_ci_opt6(color(pink))
	graph save "$dir\Results\Event Study\eventstudy_300_mdm_Never-treated_Absolute forest loss_Individual_sb+pa.gph", replace
...
foreach cgroup of global control_groups {
	...
	foreach depvar of global depvars {
		...
		foreach ttype of global treatment_types {
			...
			if "`ttype'" == "col" {
				grc1leg "$dir\Results\Event Study\eventstudy_300_mdm_`cgroup_label'_`depvar_label'_`ttype_label'_sb.gph" ///
						"$dir\Results\Event Study\eventstudy_300_mdm_`cgroup_label'_`depvar_label'_`ttype_label'_sb+pa.gph" ///
						"$dir\Results\Event Study\eventstudy_300_mdm_`cgroup_label'_`depvar_label'_`ttype_label'_sb+it.gph" ///
						"$dir\Results\Event Study\eventstudy_300_mdm_`cgroup_label'_`depvar_label'_`ttype_label'_sb+pa+it.gph", ///
						rows(2) cols(2) title("Panel `panel2'. `ttype_label' SB Contracts", size(medium) pos(11))
				graph save "$dir\Results\Event Study\eventstudy_300_mdm_`cgroup_label'_`depvar_label'_`ttype_label'.gph", replace
			}
			if "`ttype'" == "ind" {
				grc1leg "$dir\Results\Event Study\eventstudy_300_mdm_`cgroup_label'_`depvar_label'_`ttype_label'_sb.gph" ///
						"$dir\Results\Event Study\eventstudy_300_mdm_`cgroup_label'_`depvar_label'_`ttype_label'_sb+pa.gph" ///
...
foreach cgroup of global control_groups {
	...
	foreach depvar of global depvars {
		...
		grc1leg "$dir\Results\Event Study\eventstudy_300_mdm_`cgroup_label'_`depvar_label'_Collective.gph" ///
				"$dir\Results\Event Study\eventstudy_300_mdm_`cgroup_label'_`depvar_label'_Individual.gph", ///
				rows(2) cols(1) position(5) ring(0)
		graph save "$dir\Results\Event Study\eventstudy_300_mdm_`cgroup_label'_`depvar_label'_sociobosque.gph", replace
		graph export "$dir\Results\Event Study\eventstudy_300_mdm_`cgroup_label'_`depvar_label'_sociobosque.png", as(png) replace width(10000) height(12000)
		...
		foreach ttype of global treatment_types {
			...
			foreach policy_bundle of global policy_bundles {
				...
				* Group and time fixed effects are automatically controlled for.
				...
				gen canton_id = cantonid
					* Without controls
					did_multiplegt_dyn `depvar' pointid year post, weight(_weight) effects(10) placebo(10)
...
/*
					* With controls
					did_multiplegt_dyn `depvar' pointid year post, weight(_weight) normalized normalized_weights_weights effects(10) placebo(10) cluster(cantonid) controls(cantonid_year $cv) // trends_nonparam(canton_id) // parallel trends and no anticipation assumptions tests will fail!
...
*/
				...
				* Cohort identifiers: missing = never-treated.
					display "==================== did_imputation (Borusyak et al., 2024) ===================="
					* Without controls
					did_imputation `depvar' pointid year sociobosque_year [aweight = _weight], autosample fe(pointid year) cluster(cantonid) pretrends(10) horizons(0/10)
					estimates store imput_`ttype'_`j'_`pb'
					
/*
					* With controls
					did_imputation `depvar' pointid year sociobosque_year [aweight = _weight], autosample fe(pointid year) cluster(cantonid) pretrends(10) horizons(0/10) controls($cv)
...
*/
				...
				* wboot: Request Estimation of Standard errors using a multiplicative WildBootstrap procedure. The default uses 999 repetitions using mammen approach.
				display "==================== csdid (Callaway & Sant'Anna, 2021) ===================="			
					* Without controls
					csdid `depvar' [iweight = _weight], i(pointid) t(year) gvar(first_treat) method(drimp) agg(event) cluster(cantonid) long2 `= cond("`cgroup'"=="notyet", "notyet", "")'
...
*/
				...
				* Cohort identifiers should be set to be missing for never treated units.
				...
				replace L10event = (distyear >= 10 & _treated == 1) // Leave out the distant leads due to few observations. Implicitly this assumes that effects outside the lead windows are zero.
					...
					* Without controls
					eventstudyinteract `depvar' F*event L*event [fweight = _weight], cohort(sociobosque_year) control_cohort(control_cohort) absorb(pointid year) vce(cluster cantonid)
...
/*
					* With controls
					eventstudyinteract `depvar' F*event L*event [fweight = _weight], cohort(sociobosque_year) control_cohort(control_cohort) absorb(pointid year) vce(cluster cantonid) covariates($cv)
...
*/
				...
				* Cohort identifiers must be missing for never treated units.
				...
				if "`cgroup'" == "never" {
					...
					* Without controls
					stackedev `depvar' P_* Q_* ref [fweight = _weight], cohort(sociobosque_year) time(year) never_treat(control_cohort) unit_fe(pointid) clust_unit(cantonid)
...
/*
					* With controls
					stackedev `depvar' P_* Q_* ref [fweight = _weight], cohort(sociobosque_year) time(year) never_treat(control_cohort) unit_fe(pointid) clust_unit(cantonid) covariates($cv)
...
/*
				display "==================== Heterogeneity-Robust TWFE (wooldid) (Wooldridge, 2021) ===================="
					* Without controls
					wooldid `depvar' treatment_year year sociobosque_year, att cluster(cantonid) subgroup(treatment_year) fe(pointid year) esfixedbaseperiod esAbsoluteto(-1) jointtests espre(10) espost(10)
					estimates store wooldid_`ttype'_`j'_`pb'
					
					* With controls
					wooldid `depvar' treatment_year year sociobosque_year, att cluster(cantonid) subgroup(treatment_year) fe(pointid year) controls($cv) esfixedbaseperiod esAbsoluteto(-1) jointtests espre(10) espost(10)
...
*/
				...
				**# TWFE: reghdfe
					...
					* Without controls
					reghdfe `depvar' pre_* post_* [fweight = _weight], nocons absorb(pointid year) vce(cluster cantonid)
...
*/
				...
				plottype(scatter) ciplottype(rcap) trimlead(10) trimlag(10) ///
				together perturb(-0.325(0.13)0.455)  noautolegend ///
					graph_opt(title("(`panel1') `policy_bundle_label'", size(medlarge)) ///
						xtitle("Periods since the event") ytitle("Estimate of ATT and 95% Conf. Int.") ///
						xlabel(-10(1)10) ylabel(-0.06(0.01)0.03) ///
						legend(order(1 "TWFE"					3 "Borusyak et al. (2024)"	5 "Callaway & Sant'Anna (2021)" ///
